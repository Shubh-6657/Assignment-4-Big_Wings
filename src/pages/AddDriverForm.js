          ...
          <div>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker
                ...
                onChange={(newValue) =>{
                  //  console.log();
                 // setFormData({ ...formData, date: newValue.format('MM/DD/YYYY') })
                  setValue('date',newValue.format('MM/DD/YYYY'))
                }
                }
          ...
          <div>
            ...
            <input
              ...
              style={{
                width: "258px",
                height: "37px",
                border: errors.phoneNo ? "1px solid red" : "1px solid #ccc",
              }}
            />
            {errors.phoneNo && (
              <Typography
          ...
          <div>
            ...
            <input
              ...
              style={{
                width: "258px",
                height: "37px",
                border: errors.ssn ? "1px solid red" : "1px solid #ccc",
              }}
            />
            {errors.ssn && (
              <Typography
          ...
          <div>
            ...
            {errors.zipcode && (
              <Typography
                ...
                sx={{ fontSize: "12px" }}
              >
                Zip Code must contain only numeric characters
              </Typography>
            )}
          </div>
        </div>
          ...
          <div>
            ...
            {errors.status && (
              <Typography
                ...
                sx={{ fontSize: "12px" }}
              >
                Status must contain only alphabetic characters
              </Typography>
            )}
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              style={{
                width: "258px",
                height: "37px",
                border: errors.licenseCase ? "1px solid red" : "1px solid #ccc",
              }}
            />
            {errors.licenseCase && (
              <Typography
          ...
          <div>
            ...
            <select
              ...
              style={{
                ...
                height: "37px",
                fontSize: "13px",
                border: errors.drivingExperience
                  ? "1px solid red"
                  : "1px solid #ccc",
              }}
            >
            ...
            {errors.drivingExperience && (
              <Typography
                ...
                sx={{ fontSize: "12px" }}
              >
                Years of Commercial Driving Experience is required
              </Typography>
            )}
          </div>
        </div>
        <div
          style={{ display: "flex", justifyContent: "center", width: "553px" }}
        >
